...
export function KeyBenefits() {
  return <section id="benefits" className="py-32 bg-brand-navy-950 text-white relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-0 w-96 h-96 bg-blue-500/20 rounded-full blur-3xl" />
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          duration: 0.8
            ...
            <div className="space-y-6">
              {['100% Purchase Price Funding - No capital required from partners', '50% Profit Sharing - Equal split of net operating income', '50% Ownership - True equity partnership from day one', 'Secure Asset Backing - Investments secured by real assets', 'Passive Income Focus - Built for long-term cash flow'].map((benefit, index) => <motion.div key={index} initial={{
              opacity: 0,
              x: -20
            }} whileInView={{
              opacity: 1,
              ...
              duration: 0.6
                  ...
                  <CheckCircle2 className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1 group-hover:scale-110 transition-transform duration-300" />
            ...
            <div className="relative bg-white/5 border border-white/10 p-12 rounded-3xl shadow-luxury-lg backdrop-blur-sm">
              ...
              <div className="flex items-center justify-center gap-6 mb-10">
                <div className="text-center p-6 bg-white/5 rounded-2xl flex-1 border border-white/10">
                  <div className="text-4xl font-serif font-semibold text-emerald-400 mb-2">
                    100%
                  </div>
                ...
                <div className="text-3xl font-serif text-emerald-500">&</div>
                <div className="text-center p-6 bg-white/5 rounded-2xl flex-1 border border-white/10">
