...
export function KeyBenefits() {
  return (
    <section
      id="benefits"
      className="py-20 sm:py-28 lg:py-32 bg-brand-navy-950 text-white relative overflow-hidden"
    >
      ...
      {/* Ambient Glows */}
      <div className="absolute top-1/4 right-0 w-72 h-72 sm:w-96 sm:h-96 bg-[#299963]/20 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 left-0 w-72 h-72 sm:w-96 sm:h-96 bg-[#D3AF5E]/20 rounded-full blur-3xl" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif font-semibold mb-6 sm:mb-8 leading-tight">
              Why Partner With{' '}
            ...
            <p className="text-slate-400 text-base sm:text-lg md:text-xl mb-8 sm:mb-12 leading-relaxed font-light">
            ...
            <div className="space-y-4 sm:space-y-6">
              {[
                ...
                >
                  ...
                  <span className="text-sm sm:text-base md:text-lg text-slate-300 font-light">
                    {benefit}
                  </span>
                </motion.div>
              ))}
          ...
          >
            ...
            <div className="relative bg-white/5 border border-white/10 p-8 sm:p-12 rounded-3xl shadow-luxury-lg backdrop-blur-sm">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mb-6 sm:mb-10">
                <div className="text-center p-4 sm:p-6 bg-white/5 rounded-2xl flex-1 border border-white/10">
                  <div className="text-3xl sm:text-4xl font-serif font-semibold text-[#299963] mb-1 sm:mb-2">
                    100%
                  </div>
              ...
              <div className="text-center">
                <p className="text-sm sm:text-base md:text-lg text-slate-300 italic font-light leading-relaxed">
